...
class TestRniDeelnemer(unittest.TestCase):
    """RniDeelnemer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RniDeelnemer:
        """Test RniDeelnemer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RniDeelnemer`
        """
        model = RniDeelnemer()
        if include_optional:
            return RniDeelnemer(
