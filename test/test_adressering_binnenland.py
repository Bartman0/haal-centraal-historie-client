...
class TestAdresseringBinnenland(unittest.TestCase):
    """AdresseringBinnenland unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdresseringBinnenland:
        """Test AdresseringBinnenland
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdresseringBinnenland`
        """
        model = AdresseringBinnenland()
        if include_optional:
            return AdresseringBinnenland(
    ...
    def testAdresseringBinnenland(self):
        """Test AdresseringBinnenland"""
