...
class TestAdresseringBuitenlandInOnderzoek(unittest.TestCase):
    """AdresseringBuitenlandInOnderzoek unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdresseringBuitenlandInOnderzoek:
        """Test AdresseringBuitenlandInOnderzoek
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdresseringBuitenlandInOnderzoek`
        """
        model = AdresseringBuitenlandInOnderzoek()
        if include_optional:
            return AdresseringBuitenlandInOnderzoek(
    ...
    def testAdresseringBuitenlandInOnderzoek(self):
        """Test AdresseringBuitenlandInOnderzoek"""
