...
class TestVerblijfadresLocatie(unittest.TestCase):
    """VerblijfadresLocatie unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VerblijfadresLocatie:
        """Test VerblijfadresLocatie
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VerblijfadresLocatie`
        """
        model = VerblijfadresLocatie()
        if include_optional:
            return VerblijfadresLocatie(
    ...
    def testVerblijfadresLocatie(self):
        """Test VerblijfadresLocatie"""
