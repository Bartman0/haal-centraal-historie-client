...
class TestVerblijfadresLocatieInOnderzoek(unittest.TestCase):
    """VerblijfadresLocatieInOnderzoek unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VerblijfadresLocatieInOnderzoek:
        """Test VerblijfadresLocatieInOnderzoek
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VerblijfadresLocatieInOnderzoek`
        """
        model = VerblijfadresLocatieInOnderzoek()
        if include_optional:
            return VerblijfadresLocatieInOnderzoek(
    ...
    def testVerblijfadresLocatieInOnderzoek(self):
        """Test VerblijfadresLocatieInOnderzoek"""
