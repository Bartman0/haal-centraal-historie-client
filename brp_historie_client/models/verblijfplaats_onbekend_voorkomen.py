...
class VerblijfplaatsOnbekendVoorkomen(AbstractVerblijfplaatsVoorkomen):
    """
    ...
    in_onderzoek: Optional[VerblijfplaatsOnbekendVoorkomenInOnderzoek] = Field(default=None, alias="inOnderzoek")
    rni: Optional[RniDeelnemer] = None
    __properties: ClassVar[List[str]] = ["type", "datumVan", "datumTot", "gemeenteVanInschrijving", "inOnderzoek", "rni"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "inOnderzoek": VerblijfplaatsOnbekendVoorkomenInOnderzoek.from_dict(obj["inOnderzoek"]) if obj.get("inOnderzoek") is not None else None,
