...
class AdresseringBuitenland(BaseModel):
    """
    ...
    adresregel3: Optional[Annotated[str, Field(strict=True, max_length=35)]] = Field(default=None, description="Het derde deel van een adres is optioneel. Het gaat om een of meer geografische gebieden van het adres in het buitenland. ")
    land: Optional[Waardetabel] = None
    in_onderzoek: Optional[AdresseringBuitenlandInOnderzoek] = Field(default=None, alias="inOnderzoek")
    __properties: ClassVar[List[str]] = ["adresregel1", "adresregel2", "adresregel3", "land", "inOnderzoek"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "inOnderzoek": AdresseringBuitenlandInOnderzoek.from_dict(obj["inOnderzoek"]) if obj.get("inOnderzoek") is not None else None
        })
        return _obj
