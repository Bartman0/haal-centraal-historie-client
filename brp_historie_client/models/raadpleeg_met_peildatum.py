...
class RaadpleegMetPeildatum(HistorieQuery):
    """
    RaadpleegMetPeildatum
    """ # noqa: E501
    peildatum: date = Field(description="De datum waarop de resource wordt opgevraagd. ")
    __properties: ClassVar[List[str]] = ["type", "burgerservicenummer", "peildatum"]
