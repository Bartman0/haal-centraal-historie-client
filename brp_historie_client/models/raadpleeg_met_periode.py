...
class RaadpleegMetPeriode(HistorieQuery):
    """
    RaadpleegMetPeriode
    """ # noqa: E501
    datum_van: date = Field(description="De begindatum van de periode waarover de resource wordt opgevraagd. ", alias="datumVan")
    datum_tot: date = Field(description="De einddatum van de periode waarover de resource wordt opgevraagd. ", alias="datumTot")
    __properties: ClassVar[List[str]] = ["type", "burgerservicenummer", "datumVan", "datumTot"]
