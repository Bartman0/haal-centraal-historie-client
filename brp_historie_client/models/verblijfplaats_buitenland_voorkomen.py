...
class VerblijfplaatsBuitenlandVoorkomen(AbstractVerblijfplaatsVoorkomen):
    """
    * **land** - land waar de persoon is overleden. Wordt gevuld met waarden uit de landelijke tabel 'Landen'. 
    """ # noqa: E501
    verblijfadres: Optional[VerblijfadresBuitenland] = None
    ...
    in_onderzoek: Optional[VerblijfplaatsBuitenlandVoorkomenInOnderzoek] = Field(default=None, alias="inOnderzoek")
    rni: Optional[RniDeelnemer] = None
    adressering: Optional[AdresseringBuitenland] = None
    __properties: ClassVar[List[str]] = ["type", "verblijfadres", "datumVan", "datumTot", "gemeenteVanInschrijving", "inOnderzoek", "rni", "adressering"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of rni
        if self.rni:
            _dict['rni'] = self.rni.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "verblijfadres": VerblijfadresBuitenland.from_dict(obj["verblijfadres"]) if obj.get("verblijfadres") is not None else None,
            ...
            "inOnderzoek": VerblijfplaatsBuitenlandVoorkomenInOnderzoek.from_dict(obj["inOnderzoek"]) if obj.get("inOnderzoek") is not None else None,
            "rni": RniDeelnemer.from_dict(obj["rni"]) if obj.get("rni") is not None else None,
            "adressering": AdresseringBuitenland.from_dict(obj["adressering"]) if obj.get("adressering") is not None else None
        })
        return _obj
