...
class DatumOnbekend(AbstractDatum):
    """
    representatie voor een volledig onbekend datum
    """ # noqa: E501
    onbekend: StrictBool
    __properties: ClassVar[List[str]] = ["type", "langFormaat", "onbekend"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "onbekend": obj.get("onbekend") if obj.get("onbekend") is not None else True
        })
        return _obj
