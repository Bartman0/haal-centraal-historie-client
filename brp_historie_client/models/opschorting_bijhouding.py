...
class OpschortingBijhouding(BaseModel):
    """
    OpschortingBijhouding
    """ # noqa: E501
    reden: Optional[Waardetabel] = None
    datum: Optional[AbstractDatum] = None
    __properties: ClassVar[List[str]] = ["reden", "datum"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of reden
        if self.reden:
            _dict['reden'] = self.reden.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "reden": Waardetabel.from_dict(obj["reden"]) if obj.get("reden") is not None else None,
            "datum": AbstractDatum.from_dict(obj["datum"]) if obj.get("datum") is not None else None
        })
        return _obj
