...
class JaarMaandDatum(AbstractDatum):
    """
    representatie voor een datum waarvan de dag onbekend is
    """ # noqa: E501
    jaar: Annotated[int, Field(le=9999, strict=True, ge=1)]
    maand: Annotated[int, Field(le=12, strict=True, ge=1)]
    __properties: ClassVar[List[str]] = ["type", "langFormaat", "jaar", "maand"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "langFormaat": obj.get("langFormaat"),
            "jaar": obj.get("jaar"),
            "maand": obj.get("maand")
        })
        return _obj
